...
exports.login = asyncHandler(async (req, res, next) => {
    ...
    if (!user) return next(new ErrorResponse('Invalid login details', 401));
    ...
    if (!isMatch) return next(new ErrorResponse('Invalid login details', 401));
...
exports.forgotPassword = asyncHandler(async (req, res, next) => {
    ...
    requested the reset of a password. Please go to: \n\n ${resetUrl}`;
